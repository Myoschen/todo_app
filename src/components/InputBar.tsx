...
const InputBar = () => {
    ...
    return (
        <div className='flex sm:justify-around gap-4'>
            <input onChange={e => setInput(e.target.value)} value={input} className='p-1 px-2 focus:outline-none ring-slate-400 focus:ring-2 text-lg rounded transition-all dark:bg-slate-600 dark:placeholder-white/80' type='text' placeholder='Todo something ...' />
